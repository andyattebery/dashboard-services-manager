...
public class DashboardCommandProcessor
{
    ...
    public async Task<Dictionary<string, List<Service>>> UpdateWithServicesFromProvider(IEnumerable<Service> providerServices)
    {
        ...
        var newServicesWithDefaults = new List<Service>();
        foreach (var s in filtered)
        {
            newServicesWithDefaults.Add(await _withDefaultsServiceFactory.CreateWithDefaultsAsync(s with { Autogenerated = true }));
        }
